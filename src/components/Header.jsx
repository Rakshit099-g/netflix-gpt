...
const Header = () => {
  return (
    // bg-gradient-to-b from-black it means background gradient top-->bottom and it is black
    <div className='absolute w-60 px-8 py-2 bg-gradient-to-b from-black z-40'>
